...
class REBNCONV(nn.Module):
    def __init__(self, in_ch=3, n_classes=3, dirate=1):
        ...
        self.conv_s1 = nn.Conv3d(in_ch, n_classes, 3, padding=1 * dirate, dilation=1 * dirate)
        self.bn_s1 = nn.BatchNorm3d(n_classes)
...
class U2NET(nn.Module):
    ...
    def __init__(self, n_channels=3, n_classes=3):
        ...
        self.side1 = nn.Conv3d(64, n_classes, 3, padding=1)
        self.side2 = nn.Conv3d(64, n_classes, 3, padding=1)
        self.side3 = nn.Conv3d(128, n_classes, 3, padding=1)
        self.side4 = nn.Conv3d(256, n_classes, 3, padding=1)
        self.side5 = nn.Conv3d(512, n_classes, 3, padding=1)
        self.side6 = nn.Conv3d(512, n_classes, 3, padding=1)

        self.outconv = nn.Conv3d(6, n_classes, 1)
...
class U2NETP(nn.Module):
    ...
    def __init__(self,  n_channels=3, n_classes=3):
        ...
        self.side1 = nn.Conv3d(64, n_classes, 3, padding=1)
        self.side2 = nn.Conv3d(64, n_classes, 3, padding=1)
        self.side3 = nn.Conv3d(64, n_classes, 3, padding=1)
        self.side4 = nn.Conv3d(64, n_classes, 3, padding=1)
        self.side5 = nn.Conv3d(64, n_classes, 3, padding=1)
        self.side6 = nn.Conv3d(64, n_classes, 3, padding=1)

        self.outconv = nn.Conv3d(6 * n_classes, n_classes, 1)
